...
module.exports = function (webpackEnv) {
	...
	return {
		...
		output: {
			...
			publicPath: 'auto' || paths.publicUrlOrPath,
		...
		optimization: {
			...
			//     // umdDep: {
			//     //   chunks: 'all',
			//     //   test: /[\\/]node_modules[\\/](semverhook|umfjs)[\\/]/,
			//     //   priority: 10,
			//     //   reuseExistingChunk: true,
			//     //   name: 'umdDep',
			//     // },
		...
		plugins: [
			...
			// new UmdPlugin({
			//   // remotes: {
			//   //   crm_email: federationConfig.remotes.crm_email,
			//   // },
			//   runtime: {
			...
			//         __webpack_require__.l(`${url}?date=${new Date().getTime()}`, resolve)
			//       })
			//       return window[name]
			//     },
			//   },
